...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: 'pt_BR',
    type: 'website',
    images: [{ url: 'https://fut-lance.vercel.app/og-image.png', width: 1200, height: 630, alt: 'Onde Assistir Futebol - FUT LANCE' }],
  },
  twitter: {
...
export default function OndeAssistirPage() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Onde Assistir', item: 'https://fut-lance.vercel.app/onde-assistir' },
    ],
  };
  ...
  return (
    <div>
      ...
      />
      <Script
        id="breadcrumb-schema-onde-assistir"
        type="application/ld+json"
