...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      locale: 'pt_BR',
      type: 'website',
      images: [{ url: 'https://fut-lance.vercel.app/og-image.png', width: 1200, height: 630, alt: `${time.nome} - FUT LANCE` }],
    },
    twitter: {
...
export default async function TimePage({ params }: PageProps) {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Times', item: 'https://fut-lance.vercel.app/times' },
      { '@type': 'ListItem', position: 3, name: time.nome, item: `https://fut-lance.vercel.app/times/${time.slug}` },
    ],
  };
