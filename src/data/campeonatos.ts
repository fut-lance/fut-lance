...
export const campeonatos: Record<string, Campeonato> = {
  brasileirao: {
    ...
    classificacao: [
      ...
      { pos: 10, time: 'Bragantino', pts: 36, j: 26, v: 10, e: 6, d: 10, gp: 32, gc: 29, sg: 3 },
  ...
  'serie-b': {
    ...
    classificacao: [
      ...
      { pos: 2, time: 'Novorizontino', pts: 50, j: 29, v: 14, e: 8, d: 7, gp: 49, gc: 27, sg: 22 },
      { pos: 3, time: 'Juventude', pts: 50, j: 29, v: 14, e: 8, d: 7, gp: 31, gc: 19, sg: 12 },
      ...
      { pos: 10, time: 'São Bernardo', pts: 41, j: 29, v: 11, e: 8, d: 10, gp: 40, gc: 31, sg: 9 },
      { pos: 11, time: 'Athletic-MG', pts: 41, j: 29, v: 10, e: 11, d: 8, gp: 34, gc: 31, sg: 3 },
      { pos: 12, time: 'Cuiabá', pts: 40, j: 28, v: 9, e: 13, d: 6, gp: 27, gc: 22, sg: 5 },
      { pos: 13, time: 'Goiás', pts: 39, j: 28, v: 11, e: 6, d: 11, gp: 28, gc: 34, sg: -6 },
