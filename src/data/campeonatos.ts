...
export const campeonatos: Record<string, Campeonato> = {
  ...
  'serie-b': {
    ...
    classificacao: [
      ...
      { pos: 3, time: 'Fortaleza', pts: 48, j: 28, v: 13, e: 9, d: 6, gp: 31, gc: 23, sg: 8 },
      { pos: 4, time: 'Vila Nova', pts: 47, j: 27, v: 14, e: 5, d: 8, gp: 39, gc: 30, sg: 9 },
      ...
      { pos: 7, time: 'Operário', pts: 43, j: 27, v: 12, e: 7, d: 8, gp: 36, gc: 33, sg: 3 },
      ...
      { pos: 12, time: 'Náutico', pts: 37, j: 27, v: 10, e: 7, d: 10, gp: 32, gc: 30, sg: 2 },
      ...
      { pos: 16, time: 'Botafogo-SP', pts: 31, j: 27, v: 8, e: 7, d: 12, gp: 30, gc: 32, sg: -2 },
      { pos: 17, time: 'Avaí', pts: 29, j: 27, v: 8, e: 5, d: 14, gp: 28, gc: 35, sg: -7 },
