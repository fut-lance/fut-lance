...
export const campeonatos: Record<string, Campeonato> = {
  ...
  'serie-b': {
    ...
    classificacao: [
      ...
      { pos: 6, time: 'Atlético-GO', pts: 46, j: 29, v: 12, e: 10, d: 7, gp: 36, gc: 27, sg: 9 },
      { pos: 7, time: 'CRB', pts: 45, j: 29, v: 13, e: 6, d: 10, gp: 42, gc: 41, sg: 1 },
      ...
      { pos: 10, time: 'Goiás', pts: 42, j: 29, v: 12, e: 6, d: 11, gp: 30, gc: 35, sg: -5 },
      { pos: 11, time: 'São Bernardo', pts: 41, j: 29, v: 11, e: 8, d: 10, gp: 40, gc: 31, sg: 9 },
      { pos: 12, time: 'Athletic-MG', pts: 41, j: 29, v: 10, e: 11, d: 8, gp: 34, gc: 31, sg: 3 },
      { pos: 13, time: 'Cuiabá', pts: 40, j: 28, v: 9, e: 13, d: 6, gp: 27, gc: 22, sg: 5 },
