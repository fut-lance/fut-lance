...
export const campeonatos: Record<string, Campeonato> = {
  ...
  'serie-b': {
    ...
    classificacao: [
      ...
      { pos: 3, time: 'Juventude', pts: 50, j: 28, v: 14, e: 8, d: 6, gp: 30, gc: 17, sg: 13 },
      ...
      { pos: 9, time: 'São Bernardo', pts: 41, j: 29, v: 11, e: 8, d: 10, gp: 40, gc: 31, sg: 9 },
      { pos: 10, time: 'Sport', pts: 41, j: 28, v: 10, e: 11, d: 7, gp: 37, gc: 28, sg: 9 },
