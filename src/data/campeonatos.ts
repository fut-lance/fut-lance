...
export const campeonatos: Record<string, Campeonato> = {
  brasileirao: {
    ...
    classificacao: [
      ...
      { pos: 9, time: 'Red Bull Bragantino', pts: 35, j: 25, v: 10, e: 5, d: 10, gp: 31, gc: 28, sg: 3 },
      { pos: 10, time: 'São Paulo', pts: 33, j: 25, v: 9, e: 6, d: 10, gp: 31, gc: 28, sg: 3 },
      { pos: 11, time: 'Vitória', pts: 32, j: 26, v: 9, e: 5, d: 12, gp: 24, gc: 37, sg: -12 },
      { pos: 12, time: 'Corinthians', pts: 32, j: 26, v: 8, e: 8, d: 10, gp: 26, gc: 27, sg: 0 },
      ...
      { pos: 15, time: 'Grêmio', pts: 28, j: 25, v: 7, e: 7, d: 11, gp: 27, gc: 32, sg: -6 },
    ...
    artilheiros: [
      { pos: 1, jogador: 'Viveros', time: 'Athletico-PR', gols: 18 },
      { pos: 2, jogador: 'Pedro', time: 'Flamengo', gols: 16 },
      { pos: 3, jogador: 'Carlos Vinícius', time: 'Grêmio', gols: 11 },
      { pos: 4, jogador: 'John Kennedy', time: 'Fluminense', gols: 10 },
      { pos: 5, jogador: 'Flaco López', time: 'Palmeiras', gols: 9 },
    ],
  },
  libertadores: {
