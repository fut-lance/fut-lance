...
export const campeonatos: Record<string, Campeonato> = {
  brasileirao: {
    ...
    classificacao: [
      ...
      { pos: 11, time: 'São Paulo', pts: 33, j: 26, v: 9, e: 6, d: 11, gp: 31, gc: 30, sg: 1 },
      { pos: 12, time: 'Vitória', pts: 33, j: 27, v: 9, e: 6, d: 12, gp: 27, gc: 39, sg: -12 },
      { pos: 13, time: 'Corinthians', pts: 32, j: 27, v: 8, e: 8, d: 11, gp: 28, gc: 29, sg: -1 },
      { pos: 14, time: 'Botafogo', pts: 32, j: 26, v: 8, e: 8, d: 10, gp: 38, gc: 41, sg: -3 },
      { pos: 15, time: 'Mirassol', pts: 29, j: 27, v: 7, e: 8, d: 12, gp: 31, gc: 42, sg: -11 },
      { pos: 16, time: 'Grêmio', pts: 28, j: 26, v: 7, e: 7, d: 12, gp: 28, gc: 35, sg: -7 },
  ...
  'serie-b': {
    ...
    classificacao: [
      { pos: 1, time: 'Juventude', pts: 50, j: 27, v: 14, e: 8, d: 5, gp: 30, gc: 15, sg: 15 },
      { pos: 2, time: 'Novorizontino', pts: 49, j: 27, v: 14, e: 7, d: 6, gp: 47, gc: 24, sg: 23 },
      { pos: 3, time: 'Vila Nova', pts: 47, j: 27, v: 14, e: 5, d: 8, gp: 39, gc: 30, sg: 9 },
      { pos: 4, time: 'Fortaleza', pts: 47, j: 27, v: 13, e: 8, d: 6, gp: 30, gc: 22, sg: 8 },
      { pos: 5, time: 'Criciúma', pts: 47, j: 27, v: 13, e: 8, d: 6, gp: 28, gc: 21, sg: 7 },
      { pos: 6, time: 'Operário', pts: 43, j: 27, v: 12, e: 7, d: 8, gp: 36, gc: 33, sg: 3 },
      { pos: 7, time: 'Atlético-GO', pts: 43, j: 27, v: 11, e: 10, d: 6, gp: 32, gc: 26, sg: 6 },
      { pos: 8, time: 'CRB', pts: 42, j: 27, v: 12, e: 6, d: 9, gp: 40, gc: 39, sg: 1 },
      { pos: 9, time: 'Sport', pts: 41, j: 27, v: 10, e: 11, d: 6, gp: 36, gc: 26, sg: 10 },
      { pos: 10, time: 'Cuiabá', pts: 39, j: 27, v: 9, e: 12, d: 6, gp: 26, gc: 21, sg: 5 },
      { pos: 11, time: 'Náutico', pts: 37, j: 27, v: 10, e: 7, d: 10, gp: 32, gc: 30, sg: 2 },
      { pos: 12, time: 'Athletic-MG', pts: 37, j: 27, v: 9, e: 10, d: 8, gp: 31, gc: 30, sg: 1 },
      { pos: 13, time: 'Goiás', pts: 36, j: 27, v: 10, e: 6, d: 11, gp: 25, gc: 33, sg: -8 },
      { pos: 14, time: 'São Bernardo', pts: 35, j: 27, v: 9, e: 8, d: 10, gp: 37, gc: 31, sg: 6 },
      { pos: 15, time: 'Botafogo-SP', pts: 31, j: 27, v: 8, e: 7, d: 12, gp: 30, gc: 32, sg: -2 },
      { pos: 16, time: 'Ceará', pts: 31, j: 27, v: 8, e: 7, d: 12, gp: 28, gc: 35, sg: -7 },
      { pos: 17, time: 'Avaí', pts: 29, j: 27, v: 6, e: 7, d: 14, gp: 32, gc: 39, sg: -7 },
      { pos: 18, time: 'Londrina', pts: 25, j: 27, v: 4, e: 5, d: 18, gp: 21, gc: 46, sg: -25 },
      { pos: 19, time: 'América-MG', pts: 17, j: 27, v: 2, e: 4, d: 21, gp: 16, gc: 56, sg: -40 },
      { pos: 20, time: 'Ponte Preta', pts: 10, j: 27, v: 2, e: 4, d: 21, gp: 10, gc: 50, sg: -40 },
    ],
    artilheiros: [
