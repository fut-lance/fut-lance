...
export const campeonatos: Record<string, Campeonato> = {
  brasileirao: {
    ...
    classificacao: [
      { pos: 1, time: 'Flamengo', pts: 60, j: 28, v: 18, e: 6, d: 4, gp: 55, gc: 23, sg: 32 },
      { pos: 2, time: 'Palmeiras', pts: 57, j: 28, v: 16, e: 9, d: 3, gp: 47, gc: 21, sg: 26 },
      { pos: 3, time: 'Athletico-PR', pts: 49, j: 28, v: 14, e: 7, d: 7, gp: 43, gc: 32, sg: 11 },
      { pos: 4, time: 'Fluminense', pts: 48, j: 28, v: 13, e: 9, d: 6, gp: 44, gc: 36, sg: 8 },
      { pos: 5, time: 'Bahia', pts: 46, j: 28, v: 12, e: 10, d: 6, gp: 43, gc: 35, sg: 8 },
      { pos: 6, time: 'Cruzeiro', pts: 45, j: 28, v: 13, e: 6, d: 9, gp: 42, gc: 40, sg: 2 },
      { pos: 7, time: 'Atlético-MG', pts: 40, j: 27, v: 11, e: 7, d: 9, gp: 36, gc: 32, sg: 4 },
      { pos: 8, time: 'Santos', pts: 38, j: 27, v: 10, e: 8, d: 9, gp: 41, gc: 40, sg: 1 },
      { pos: 9, time: 'Coritiba', pts: 38, j: 28, v: 10, e: 8, d: 10, gp: 37, gc: 43, sg: -6 },
      { pos: 10, time: 'Bragantino', pts: 36, j: 27, v: 10, e: 6, d: 11, gp: 33, gc: 31, sg: 2 },
      { pos: 11, time: 'São Paulo', pts: 36, j: 27, v: 10, e: 6, d: 11, gp: 32, gc: 30, sg: 2 },
      { pos: 12, time: 'Botafogo', pts: 35, j: 28, v: 9, e: 8, d: 11, gp: 41, gc: 45, sg: -4 },
      { pos: 13, time: 'Vitória', pts: 33, j: 28, v: 9, e: 6, d: 13, gp: 28, gc: 42, sg: -14 },
      { pos: 14, time: 'Corinthians', pts: 32, j: 28, v: 8, e: 8, d: 12, gp: 29, gc: 32, sg: -3 },
  ...
  'serie-b': {
    ...
    classificacao: [
      { pos: 1, time: 'Vila Nova', pts: 51, j: 29, v: 15, e: 6, d: 8, gp: 41, gc: 31, sg: 10 },
      { pos: 2, time: 'Fortaleza', pts: 51, j: 29, v: 14, e: 9, d: 6, gp: 33, gc: 24, sg: 9 },
      { pos: 3, time: 'Novorizontino', pts: 50, j: 29, v: 14, e: 8, d: 7, gp: 49, gc: 27, sg: 22 },
      { pos: 4, time: 'Juventude', pts: 50, j: 29, v: 14, e: 8, d: 7, gp: 31, gc: 19, sg: 12 },
      { pos: 5, time: 'Operário', pts: 47, j: 29, v: 13, e: 8, d: 8, gp: 41, gc: 36, sg: 5 },
      { pos: 6, time: 'Criciúma', pts: 47, j: 29, v: 13, e: 8, d: 8, gp: 28, gc: 27, sg: 1 },
      { pos: 7, time: 'Atlético-GO', pts: 46, j: 29, v: 12, e: 10, d: 7, gp: 36, gc: 27, sg: 9 },
      { pos: 8, time: 'CRB', pts: 45, j: 29, v: 13, e: 6, d: 10, gp: 42, gc: 41, sg: 1 },
      { pos: 9, time: 'Sport', pts: 44, j: 29, v: 11, e: 11, d: 7, gp: 39, gc: 29, sg: 10 },
      { pos: 10, time: 'Cuiabá', pts: 43, j: 29, v: 10, e: 13, d: 6, gp: 30, gc: 22, sg: 8 },
      { pos: 11, time: 'Goiás', pts: 42, j: 29, v: 12, e: 6, d: 11, gp: 30, gc: 35, sg: -5 },
      { pos: 12, time: 'São Bernardo', pts: 41, j: 29, v: 11, e: 8, d: 10, gp: 40, gc: 31, sg: 9 },
      { pos: 13, time: 'Athletic-MG', pts: 41, j: 29, v: 10, e: 11, d: 8, gp: 34, gc: 31, sg: 3 },
      { pos: 14, time: 'Náutico', pts: 38, j: 29, v: 10, e: 8, d: 11, gp: 35, gc: 36, sg: -1 },
      { pos: 15, time: 'Ceará', pts: 35, j: 29, v: 9, e: 8, d: 12, gp: 31, gc: 37, sg: -6 },
      { pos: 16, time: 'Botafogo-SP', pts: 32, j: 29, v: 8, e: 8, d: 13, gp: 32, gc: 36, sg: -4 },
      { pos: 17, time: 'Avaí', pts: 30, j: 29, v: 8, e: 6, d: 15, gp: 30, gc: 38, sg: -8 },
      { pos: 18, time: 'Londrina', pts: 28, j: 29, v: 7, e: 7, d: 15, gp: 39, gc: 41, sg: -2 },
      { pos: 19, time: 'América-MG', pts: 17, j: 29, v: 4, e: 5, d: 20, gp: 21, gc: 49, sg: -28 },
      { pos: 20, time: 'Ponte Preta', pts: 13, j: 29, v: 3, e: 4, d: 22, gp: 17, gc: 62, sg: -45 },
    ],
    artilheiros: [
