...
export const campeonatos: Record<string, Campeonato> = {
  brasileirao: {
    ...
    classificacao: [
      ...
      { pos: 5, time: 'Bahia', pts: 46, j: 27, v: 12, e: 10, d: 5, gp: 42, gc: 33, sg: 9 },
  ...
  'serie-b': {
    ...
    classificacao: [
      ...
      { pos: 14, time: 'Náutico', pts: 37, j: 27, v: 10, e: 7, d: 10, gp: 32, gc: 30, sg: 2 },
      ...
      { pos: 20, time: 'Ponte Preta', pts: 10, j: 27, v: 2, e: 4, d: 21, gp: 16, gc: 56, sg: -40 },
    ],
    artilheiros: [
