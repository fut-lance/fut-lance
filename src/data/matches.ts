...
export const matches: Match[] = [
  ...
  },
  {
    ...
    status: 'em-breve',
    canais: [
      { nome: 'Paramount+', url: 'http://xigfh01.site:80/***/***/618.m3u8' },
    ],
  },
  {
    id: 'sb-001',
    ...
    status: 'em-breve',
    canais: [
      { nome: 'Premiere', url: 'http://xigfh01.site:80/***/***/594.m3u8' },
    ],
  },
  {
    id: 'sb-002',
    ...
    status: 'em-breve',
    canais: [
      { nome: 'Disney+', url: 'http://xigfh01.site:80/***/***/595.m3u8' },
    ],
  },
  {
    id: 'sb-003',
    ...
    status: 'em-breve',
    canais: [
      { nome: 'ESPN4', url: 'http://xigfh01.site:80/***/***/619.m3u8' },
    ],
  },
];
