...
export const matches: Match[] = [
  {
    ...
    status: 'em-breve',
    canais: [
      { nome: 'TNT Sports', url: 'http://xigfh01.site:80/***/***/588.m3u8' },
    ],
  },
  {
    id: 'champ-002',
    ...
    status: 'em-breve',
    canais: [
      { nome: 'Space', url: 'http://xigfh01.site:80/***/***/589.m3u8' },
    ],
  },
  {
    id: 'champ-003',
    ...
    status: 'em-breve',
    canais: [
      { nome: 'TNT', url: 'http://xigfh01.site:80/***/***/594.m3u8' },
    ],
  },
  {
    id: 'champ-004',
    ...
    status: 'em-breve',
    canais: [
      { nome: 'Space', url: 'http://xigfh01.site:80/***/***/595.m3u8' },
    ],
  },
  {
    id: 'champ-005',
    ...
    status: 'em-breve',
    canais: [
      { nome: 'HBO Max', url: 'http://xigfh01.site:80/***/***/618.m3u8' },
    ],
  },
  {
    id: 'champ-006',
    ...
    status: 'em-breve',
    canais: [
      { nome: 'HBO Max', url: 'http://xigfh01.site:80/***/***/619.m3u8' },
    ],
  },
  {
    id: 'lib-001',
    ...
    status: 'em-breve',
    canais: [
      { nome: 'ESPN', url: 'http://xigfh01.site:80/***/***/620.m3u8' },
    ],
  },
];
