...
export const matches: Match[] = [
  ...
  {
    id: 'serb-21-001',
    slug: generateSlug('Criciúma', 'Operário-PR'),
    competicao: 'Brasileirão Série B',
    data: '21/09/2026',
    horario: '19:30',
    timeMandante: 'Criciúma',
    logoTimeMandante: 'https://commons.wikimedia.org/wiki/Special:FilePath/Crici%C3%BAma_EC_2025_crest.svg?width=500',
    timeVisitante: 'Operário-PR',
    logoTimeVisitante: 'https://logodetimes.com/times/operario-pr/logo-operario-pr-2048.png',
    status: 'em-breve',
    canais: [
      { nome: 'ESPN FHD', url: `/api/stream?ch=424142` },
      { nome: 'ESPN HD', url: `/api/stream?ch=424143` },
      { nome: 'Disney+', url: '' },
    ],
  },
  {
    id: 'serb-21-002',
    slug: generateSlug('Cuiabá', 'Náutico'),
    competicao: 'Brasileirão Série B',
    data: '21/09/2026',
    horario: '21:30',
    timeMandante: 'Cuiabá',
    logoTimeMandante: 'https://logodetimes.com/times/cuiaba/logo-cuiaba-2048.png',
    timeVisitante: 'Náutico',
    logoTimeVisitante: 'https://logodetimes.com/times/nautico/logo-nautico-2048.png',
    status: 'em-breve',
    canais: [
    ],
  },
