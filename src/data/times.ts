...
export const times: Record<string, Time> = {
  flamengo: {
    ...
    descricao: 'Clube de Regatas do Flamengo é o maior clube do Brasil em número de torcedores. Fundado em 1895, se tornou referência no futebol brasileiro com títulos nacionais e internacionais. Em 2026, o Flamengo disputa o Brasileirão e a Libertadores.',
    titulos: {
      brasileirao: 8,
      copaDoBrasil: 5,
      libertadores: 4,
    ...
    elenco: [
      { posicao: 'Goleiros', jogadores: ['Rossi', 'Andrew', 'Dyogo Alves'] },
      { posicao: 'Laterais', jogadores: ['Varela', 'Ayrton Lucas', 'Emerson Royal', 'Alex Sandro'] },
      { posicao: 'Zagueiros', jogadores: ['Léo Ortiz', 'Léo Pereira', 'Danilo', 'Vitão'] },
      { posicao: 'Volantes', jogadores: ['Erick Pulgar', 'Jorginho', 'De la Cruz', 'Evertton Araújo'] },
      { posicao: 'Meias', jogadores: ['De Arrascaeta', 'Lucas Paquetá', 'Carrascal', 'Saúl Ñíguez'] },
      { posicao: 'Atacantes', jogadores: ['Pedro', 'Samuel Lino', 'Luiz Araújo', 'Bruno Henrique', 'Gonzalo Plata'] },
    ],
    proximosJogos: [
      { data: '13/09/2026', horario: '17:30', adversario: 'Corinthians', competicao: 'Brasileirão', local: 'Casa' },
      { data: '24/09/2026', horario: '19:00', adversario: 'Libertadores', competicao: 'Libertadores', local: 'Casa' },
    ],
  },
  palmeiras: {
    nome: 'Palmeiras',
    ...
    elenco: [
      { posicao: 'Goleiros', jogadores: ['Carlos Miguel', 'Weverton', 'Marcelo Lomba'] },
      { posicao: 'Laterais', jogadores: ['Giay', 'Piquerez', 'Khellven', 'Jefté'] },
      { posicao: 'Zagueiros', jogadores: ['Gustavo Gómez', 'Murilo', 'Bruno Fuchs', 'Benedetti'] },
      { posicao: 'Volantes', jogadores: ['Lucas Evangelista', 'Marlon Freitas', 'Emiliano Martínez'] },
      { posicao: 'Meias', jogadores: ['Maurício', 'Andreas Pereira', 'Felipe Anderson', 'Jhon Arias'] },
      { posicao: 'Atacantes', jogadores: ['Vitor Roque', 'Flaco López', 'Paulinho', 'Ramón Sosa'] },
    ],
    proximosJogos: [
      { data: '12/09/2026', horario: '18:30', adversario: 'São Paulo', competicao: 'Brasileirão', local: 'Casa' },
      { data: '16/09/2026', horario: '19:00', adversario: 'Cerro Porteño', competicao: 'Libertadores', local: 'Fora' },
    ],
  },
  corinthians: {
    nome: 'Corinthians',
    ...
    elenco: [
      { posicao: 'Goleiros', jogadores: ['Hugo Souza', 'Felipe Longo', 'Kauê'] },
      { posicao: 'Laterais', jogadores: ['Matheuzinho', 'Matheus Bidu', 'Fabrizio Angileri', 'Hugo'] },
      { posicao: 'Zagueiros', jogadores: ['Gabriel Paulista', 'André Ramalho', 'Gustavo Henrique', 'João Pedro'] },
      { posicao: 'Volantes', jogadores: ['Raniele', 'Allan', 'Luiz Gustavo', 'Charles'] },
      { posicao: 'Meias', jogadores: ['Rodrigo Garro', 'Breno Bidon', 'Matheus Pereira', 'Memphis Depay'] },
      { posicao: 'Atacantes', jogadores: ['Yuri Alberto', 'Pedro Raul', 'Vitinho', 'Jesse Lingard'] },
    ],
    proximosJogos: [
      { data: '13/09/2026', horario: '17:30', adversario: 'Flamengo', competicao: 'Brasileirão', local: 'Fora' },
    ],
  },
  'sao-paulo': {
    nome: 'São Paulo',
    ...
    elenco: [
      { posicao: 'Goleiros', jogadores: ['Carlos Coronel', 'Rafael'] },
      { posicao: 'Laterais', jogadores: ['Cédric Soares', 'Wendell', 'Buta'] },
      { posicao: 'Zagueiros', jogadores: ['Arboleda', 'Rafael Tolói', 'Domingos Duarte'] },
      { posicao: 'Volantes', jogadores: ['Pablo Maia', 'Newton', 'Luan'] },
      { posicao: 'Meias', jogadores: ['Lucas Moura', 'Cauly', 'Marcos Antônio', 'Luciano'] },
      { posicao: 'Atacantes', jogadores: ['Calleri', 'Ferreirinha', 'Victor Sá'] },
    ],
    proximosJogos: [
